...
public class Constants {
    ...
    public static final double indexOnSpeed = 50; // 75 [trying a speed of 100 to try and maximize shots]
    public static final double indexReverseSpeed = -50;
    public static final double indexOffSpeed = 0;

    public static final double kickerOnSpeed = 50; // 75
    public static final double kickerReverseSpeed = -50;
