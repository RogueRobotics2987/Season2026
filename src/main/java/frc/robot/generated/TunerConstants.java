...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("evil canivore", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.212158203125);
